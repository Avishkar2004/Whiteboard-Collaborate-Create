                ...
                >
                    ...
                    <div className="flex items-center justify-between p-6 border-b border-gray-200">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-xl font-semibold text-gray-900">Share Elements</h2>
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <h3 className="text-lg font-medium text-gray-900">Select Elements</h3>
                            ...
                            {drawingHistory && drawingHistory.length > 0 ? (
                                ...
                                <div className="text-center py-8 text-gray-500">
                                    <p className="text-sm">No elements to share</p>
                                </div>
                            )}
                    ...
                    <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
                        ...
                        <button
                            ...
                            className="px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-lg hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                        >
                            {loading ? (
